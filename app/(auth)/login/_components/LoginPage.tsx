...
import backgrohndImage from "@/public/dashboard/login-background.png";
import nature from "@/public/dashboard/nature.svg";
...
export const Login = () => {
  ...
  return (
    <div className="grid md:grid-cols-2 p-10 md:p-0 w-full h-full bg-white">
      <div className="flex justify-end mt-auto mb-auto md:ml-40">
        <section id="login" className="w-full">
          <div className="mt-5 flex flex-col gap-2">
            <h1 className="font-bold text-5xl">Login</h1>
            <p className="opacity-60 font-medium mt-3 text-xl">
          ...
          >
              ...
              <>
                ...
                {formData.category === "user" && (
                  <input
                    ...
                    required
                    className="outline-none border-[2px] rounded-md p-4 w-full"
                  />
                )}
              </>
            )}
            ...
            <input
              ...
              onChange={handleInputChange}
              required
              className="col-span-2 outline-none border-[2px] rounded-md p-4 w-full"
            />
            ...
            <input
              ...
              required
              className="col-span-2 outline-none border-[2px] rounded-md p-4 w-full mt-3"
            />
          ...
          <h4 className="text-sm mt-5 text-center">
      ...
      <div className="relative hidden md:block">
        <Image
          ...
          alt="login bg"
        />
        <div className="absolute top-[10%]  left-[30%] text-white">
          <h1 className="text-5xl font-bold">Welcome Back To PhoneStore,</h1>
          <p>
            Designed to streamline your retail operations and enhance
            effieciency
          </p>
        </div>
      </div>
